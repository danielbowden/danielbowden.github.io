        ...
        def render(context)
            if context['page']['mapping']
                ...
                if @engine == 'google_static'
                    ...
                    return "<div id=\"jekyll-mapping\" style=\"height:150px;width:100%;\"></div>"
                end
            end
        end
    end
    ...
    class MapIndexTag < Liquid::Tag
        ...
        def render(context)
            ...
            for post in posts
                    ...
                    postinfo['link'] = Jekyll.configuration({})['url'] + post.url
            ...
            if (@engine == 'google_js')
                return "
                    <div id='jekyll-mapping' style='height:150px;width:100%;'>
                    </div>
